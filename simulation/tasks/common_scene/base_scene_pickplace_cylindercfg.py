...
class TableCylinderSceneCfg(InteractiveSceneCfg): # inherit from the interactive scene configuration class
    ...
    packing_table = AssetBaseCfg(
        ...
        spawn=UsdFileCfg(
            # usd_path="/home/umz/unitree_sim_isaaclab/assets/objects/PackingTable/PackingTable.usd",    # table model file
            # HARDCODED PATH TO FIX FILE NOT FOUND ERROR
            usd_path="/home/umz/unitree_sim_isaaclab/assets/objects/PackingTable/PackingTable.usd",    # table model file
    ...
    # --- DISABLED CAMERA TO SAVE MEMORY ---
