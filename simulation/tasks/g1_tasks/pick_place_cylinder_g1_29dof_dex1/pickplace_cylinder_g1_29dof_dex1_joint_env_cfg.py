...
class ObjectTableSceneCfg(TableCylinderSceneCfg):
    ...
    # --- CAMERAS DISABLED TO SAVE MEMORY FOR RL TRAINING ---
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        # --- CAMERA OBSERVATION DISABLED FOR RL TRAINING ---
        ...
        def __post_init__(self):
            ...
            self.concatenate_terms = True  # disable observation item connection
...
class PickPlaceG129DEX1BaseFixEnvCfg(ManagerBasedRLEnvCfg):
    ...
    # 1. scene settings
    # --- NUM_ENVS CHANGED TO 64 ---
    scene: ObjectTableSceneCfg = ObjectTableSceneCfg(num_envs=64, # environment number: 64
    ...
    def __post_init__(self):
        ...
        # --- COMMENTED OUT CUSTOM EVENT MANAGER TO FIX HYDRA/LAMBDA ERROR ---
